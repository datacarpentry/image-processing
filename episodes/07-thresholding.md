...
> to select only the coloured shapes(In this particular case we consider grayish to be a color, too) from the image `data/shapes-02.jpg`:
>
...
We use `skimage.io.imread` with the optional argument `as_gray=True` to
